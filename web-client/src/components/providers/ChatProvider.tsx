...
import { faImage, faInfoCircle, faPaperPlane, faSearch, faSpinner } from "@fortawesome/free-solid-svg-icons";
    ...
    return <>
        ...
        >
            <div className="grid grid-cols-12 h-full gap-x-2 relative">
                ...
                <div className="col-span-8 bg-gray-50 rounded-md overflow-y-hidden pb-50 h-full">
                    {selectedRoom ? <>
                        <div className="bg-white p-3 m-2 rounded-md shadow-sm flex gap-x-3 absolute top-0 w-[65%] z-10">
                            ...
                            <div className="flex-1">
                                ...
                                {selectedRoom.online ? <p className="text-green-500 font-semibold text-xs -mt-0.5">Đang hoạt động</p> : <p className="text-gray-400 font-semibold text-xs -mt-0.5">Ngoại tuyến</p>}
                            </div>
                        ...
                        <div className="flex flex-col gap-y-3 px-2 overflow-y-auto custom-scroll-no-hover h-full relative">
                            ...
                            <div ref={endRef} className="pb-20"></div>
                        </div>

                        <div className="p-2 m-2 rounded-md absolute bottom-0 w-[65%] shadow-sm bg-white">
                            <Formik
